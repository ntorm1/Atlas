...
//============================================================================
enum LinearRegressionSolver { LDLT, ColPivHouseholderQR, Lasso, Ridge };
...
//============================================================================
class LassoRegressionModelConfig : public LinearRegressionModelConfig {
public:
  double m_alpha = 1.0;
...
//============================================================================
class LinearRegressionModel : public ModelBase {
private:
