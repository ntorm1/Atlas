...
protected:
	...
	static SharedPtr<TriggerNode> registerNode(SharedPtr<TriggerNode>&& node) noexcept;
...
//============================================================================
class PeriodicTriggerNode : public TriggerNode
{
private:
	size_t m_frequency;
...
//============================================================================
class StrategyMonthlyRunnerNode : public TriggerNode
{
private:
