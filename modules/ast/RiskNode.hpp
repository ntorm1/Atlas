...
//============================================================================
class CovarianceNodeBase : public StatementNode {
private:
  bool m_cached = false;
...
//============================================================================
class CovarianceNode : public CovarianceNodeBase {
...
//============================================================================
class IncrementalCovarianceNode : public CovarianceNodeBase {
  friend class Exchange;
...
//============================================================================
class AllocationWeightNode : public StrategyBufferOpNode {
protected:
...
//============================================================================
class InvVolWeight final : public AllocationWeightNode {
private:
public:
...
//============================================================================
class RiskParityWeight final : public AllocationWeightNode {
private:
  double m_tol = 1e-6;
  int m_max_iter = 100;
  bool m_chinu = true;
