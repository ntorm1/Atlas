...
import numpy
import typing
__all__ = ['Allocator', 'CommisionManager', 'Exchange', 'Hydra', 'MetaStrategy', 'Order', 'Strategy', 'Trade']
class Allocator:
    def getAllocationBuffer(self) -> numpy.ndarray[numpy.float64[m, 1]]:
        ...
    def getHistory(self, arg0: atlas_internal.ast.TracerType) -> numpy.ndarray[numpy.float64[m, 1]]:
        ...
...
class CommisionManager:
    ...
    def setFixedCommission(self, arg0: float) -> None:
        ...
class Exchange:
    def enableNodeCache(self, arg0: str, arg1: atlas_internal.ast.StrategyBufferOpNode, arg2: bool) -> None:
        ...
...
class MetaStrategy(Allocator):
    def __init__(self, arg0: str, arg1: Exchange, arg2: Allocator | None, arg3: float) -> None:
        ...
class Order:
...
class Strategy(Allocator):
    def __init__(self, arg0: str, arg1: Exchange, arg2: Allocator, arg3: float) -> None:
        ...
    def enableTracerHistory(self, arg0: atlas_internal.ast.TracerType) -> None:
        ...
    ...
    def loadAST(self) -> atlas_internal.ast.StrategyNode:
        ...
    def setGridDimmensions(self, dimensions: tuple[..., ...], grid_type: atlas_internal.ast.GridType | None = None) -> atlas_internal.ast.StrategyGrid:
        ...
    def setVolTracer(self, arg0: atlas_internal.ast.CovarianceNodeBase) -> None:
        ...
class Trade:
